...
//     version 1.11.2
//     from Assets/Scripts/GemControls.inputactions
//
...
public partial class @GemControls: IInputActionCollection2, IDisposable
{
    ...
    ~@GemControls()
    {
        UnityEngine.Debug.Assert(!m_Base.enabled, "This will cause a leak and performance issues, GemControls.Base.Disable() has not been called.");
    }
    ...
    {
        private @GemControls m_Wrapper;
        public BaseActions(@GemControls wrapper) { m_Wrapper = wrapper; }
